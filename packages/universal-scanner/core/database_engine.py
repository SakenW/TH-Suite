...
from .scanner_interface import ContentItem, ContentType, ScanStatus, ScanProgress, ScanResult
...
class DatabaseInterface(ABC):
    ...
    @abstractmethod
    async def record_scan_discovery(self, scan_id: str, content_hash: str, content_type: ContentType) -> None:
        """记录扫描发现"""
        pass
