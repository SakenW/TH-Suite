...
from ..writeback import WritebackManager, WritebackStrategy
...
class ClientPatchManager:
    ...
    def load_cached_patch(self, patch_id: str) -> ClientPatchSet | None:
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "success_rate": (successful / total_patches * 100)
            if total_patches > 0
            else 0,
            "total_items": total_items,
            "items_succeeded": items_succeeded,
            "items_success_rate": (items_succeeded / total_items * 100)
            if total_items > 0
            else 0,
