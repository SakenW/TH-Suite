...
class ProjectStateMachine(SimpleStateMachine):
    ...
    def __init__(self):
        ...
        valid_transitions = {
            ...
            "failed": [
                ...
                "scanning",
                "processing",
            ],  # Allow retry from various states
            "cancelled": ["idle"],
        }
    ...
    def start_stage(self, stage_name: str, data: dict[str, Any] | None = None) -> bool:
    ...
    def update_progress(
        self, progress: float, current_step: str = "", total_steps: int = None
    ) -> None:
        ...
        self.progress_data[stage].update(
            {"progress": max(0.0, min(1.0, progress)), "current_step": current_step}
        )
    ...
    def complete_stage(
        self, next_stage: str = None, data: dict[str, Any] | None = None
    ) -> bool:
