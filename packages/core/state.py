...
class StateMachine(ABC):
    ...
    @abstractmethod
    def transition(self, new_state: str, data: Optional[Dict[str, Any]] = None) -> bool:
...
class SimpleStateMachine(StateMachine):
    ...
    def __init__(self, initial_state: str = "idle", valid_transitions: Optional[Dict[str, list[str]]] = None):
