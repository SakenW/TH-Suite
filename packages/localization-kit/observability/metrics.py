...
class MetricsCollector:
    ...
    def __init__(self):
        ...
        # 回调
        self.on_threshold_exceeded: Optional[Callable[[str, float], None]] = None
    ...
    def stop_timer(self, name: str, metric_name: str) -> Optional[float]:
        """
        停止计时并记录
    ...
    def get_p95_latency(self, metric_name: str) -> Optional[float]:
        """
        获取 P95 时延
