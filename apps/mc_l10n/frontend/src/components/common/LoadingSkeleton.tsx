    ...
    <Card>
      <CardContent>
        {Array.from({ length: count }).map((_, index) => (
          ...
          >
            <Skeleton variant="circular" width={40} height={40} sx={{ mr: 2 }} animation={animation} />
            <Box sx={{ flexGrow: 1 }}>
              <Skeleton variant="text" width="60%" animation={animation} />
            ...
            <Grid item xs={12} sm={6} md={3} key={index}>
              <Card>
                <CardContent sx={{ textAlign: 'center', py: 2 }}>
                  <Skeleton variant="circular" width={32} height={32} sx={{ mx: 'auto', mb: 1 }} animation={animation} />
                  <Skeleton 
                    variant="text" 
        ...
        <Grid container spacing={3} sx={{ mb: 3 }}>
          {Array.from({ length: 4 }).map((_, index) => (
            <Grid item xs={6} sm={3} key={index}>
              <Card>
                <CardContent sx={{ textAlign: 'center', py: 2 }}>
                  <Skeleton variant="circular" width={24} height={24} sx={{ mx: 'auto', mb: 1 }} animation={animation} />
                  <Skeleton 
                    variant="text" 
          ...
          <Grid item xs={12} sm={6} md={4} lg={2} key={index}>
            <Card>
              <CardContent sx={{ textAlign: 'center', py: 3 }}>
                <Skeleton variant="circular" width={40} height={40} sx={{ mx: 'auto', mb: 2 }} animation={animation} />
                <Skeleton 
                  variant="text" 
            ...
            <CardContent>
              ...
              {Array.from({ length: 5 }).map((_, index) => (
                <Box key={index} sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                  <Skeleton variant="circular" width={32} height={32} sx={{ mr: 2 }} animation={animation} />
                  <Box sx={{ flexGrow: 1 }}>
