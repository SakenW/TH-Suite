...
export const MinecraftBlock: React.FC<{
  ...
  const getBlockColor = () => {
    switch (type) {
      case 'grass': return minecraftColors.grassGreen;
      case 'stone': return minecraftColors.stoneGray;
      case 'diamond': return minecraftColors.diamondBlue;
      case 'gold': return minecraftColors.goldYellow;
      case 'iron': return minecraftColors.iron;
      case 'emerald': return '#50C878'; // 翠绿色
      default: return minecraftColors.grassGreen;
    }
  };
        ...
        {hasExploded && (
          <motion.div
            ...
            style={{
              ...
              width: size,
              height: size,
              background: 'radial-gradient(circle, #FF6B35 0%, #F7931E 30%, #FFD23F 60%, transparent 100%)',
              borderRadius: '50%',
              pointerEvents: 'none',
              fontSize: size * 0.8,
            }}
