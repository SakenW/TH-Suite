...
const TranslationWorkbench: React.FC = () => {
  ...
  const { data: statistics, execute: loadStatistics } = useApi(
    () => selectedProject ? translationService.getTranslationStatistics({ project_id: selectedProject }) : Promise.resolve(null),
    false
  );
            ...
            {statistics?.data && (
              <Grid container spacing={3} sx={{ mb: 3 }}>
                <Grid item xs={6} sm={3}>
                  ...
                  >
                    <CardContent sx={{ textAlign: 'center', py: 2 }}>
                      <FileText color={theme.palette.info.main} size={24} style={{ marginBottom: 8 }} />
                ...
                <Grid item xs={6} sm={3}>
                  ...
                  >
                    <CardContent sx={{ textAlign: 'center', py: 2 }}>
                      <CheckCircle color={theme.palette.success.main} size={24} style={{ marginBottom: 8 }} />
                ...
                <Grid item xs={6} sm={3}>
                  ...
                  >
                    <CardContent sx={{ textAlign: 'center', py: 2 }}>
                      <Clock color={theme.palette.warning.main} size={24} style={{ marginBottom: 8 }} />
                ...
                <Grid item xs={6} sm={3}>
                  ...
                  >
                    <CardContent sx={{ textAlign: 'center', py: 2 }}>
                      <BarChart3 color={theme.palette.primary.main} size={24} style={{ marginBottom: 8 }} />
        ...
        >
          {!selectedProject ? (
            <Card sx={{ textAlign: 'center', py: 8 }}>
              <CardContent>
                <Globe size={64} color={theme.palette.text.secondary} style={{ marginBottom: 24 }} />
