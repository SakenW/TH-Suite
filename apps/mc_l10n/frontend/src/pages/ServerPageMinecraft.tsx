...
export default function ServerPageMinecraft() {
  ...
  useEffect(() => {
    const autoConnect = async () => {
      ...
      if (
        savedSyncSettings?.syncOnStartup &&
        savedServerConfig?.url &&
        savedServerConfig?.apiKey &&
        !isConnected
      ) {
        await handleConnect()
      }
  ...
  return (
    <Box sx={{ p: 3 }}>
            ...
            <CardContent>
              ...
              <Grid container spacing={2} sx={{ mb: 3 }}>
                ...
                <Grid item xs={6} md={3}>
                  ...
                  <Typography variant='body2'>{serverConfig.region || 'N/A'}</Typography>
                </Grid>
                <Grid item xs={6} md={3}>
                  <Typography variant='caption' color='text.secondary'>
                    延迟
          ...
          <Box sx={{ p: 3 }}>
            ...
            <List>
              {connectionLogs.map(log => (
                ...
                >
                  <ListItemIcon>{getLogStatusIcon(log.status)}</ListItemIcon>
                  <ListItemText
                    primary={
            ...
            <Box
              sx={{ mt: 2, textAlign: 'center', display: 'flex', gap: 2, justifyContent: 'center' }}
            >
              <MinecraftButton
                minecraftStyle='stone'
                size='small'
              ...
              <Grid item xs={12} md={4}>
                <MinecraftCard variant='inventory'>
                  <CardContent>
                    ...
                    <Typography variant='caption' color='text.secondary' sx={{ mt: 1 }}>
                      成功率:{' '}
                      {((serverStats.successfulRequests / serverStats.totalRequests) * 100).toFixed(
                        2,
                      )}
                      %
                    </Typography>
              ...
              <Grid item xs={12} md={6}>
                <MinecraftCard variant='crafting'>
                  <CardContent>
                    ...
                    <FormControlLabel control={<Switch defaultChecked />} label='使用连接池' />
                  </CardContent>
                </MinecraftCard>
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                <MinecraftCard variant='crafting'>
                  <CardContent>
                    ...
                    <FormControlLabel control={<Switch />} label='使用代理' sx={{ mb: 2 }} />
                    ...
                    <TextField fullWidth label='代理用户名' disabled sx={{ mb: 2 }} />

                    <TextField fullWidth label='代理密码' type='password' disabled />
                  </CardContent>
                </MinecraftCard>
              </Grid>
              ...
              <Grid item xs={12}>
                <MinecraftCard variant='crafting'>
                  <CardContent>
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={12} md={6}>
                        <FormControlLabel control={<Switch />} label='启用详细日志' />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <FormControlLabel control={<Switch />} label='保存请求/响应数据' />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <FormControlLabel control={<Switch />} label='模拟离线模式' />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <FormControlLabel control={<Switch />} label='忽略SSL证书错误' />
                      </Grid>
                    </Grid>
      ...
      >
        <DialogTitle sx={{ fontFamily: '"Minecraft", monospace' }}>服务器配置</DialogTitle>
        <DialogContent>
          <Grid container spacing={2} sx={{ mt: 1 }}>
            <Grid item xs={12}>
              <TextField fullWidth label='服务器名称' value='Trans-Hub Server' disabled />
            </Grid>
            <Grid item xs={12}>
              <TextField
                fullWidth
                ...
                InputProps={{
                  endAdornment: (
                    <InputAdornment position='end'>
                      <IconButton edge='end' onClick={() => setShowApiKey(!showApiKey)}>
            ...
            <Grid item xs={12} md={6}>
              <FormControlLabel control={<Switch defaultChecked />} label='使用SSL加密' />
            </Grid>
          </Grid>
        </DialogContent>
        <DialogActions>
          <MinecraftButton minecraftStyle='stone' onClick={() => setConfigDialogOpen(false)}>
            取消
          </MinecraftButton>
          <MinecraftButton
            minecraftStyle='emerald'
      ...
      >
        <DialogTitle sx={{ fontFamily: '"Minecraft", monospace' }}>连接测试</DialogTitle>
        <DialogContent>
              ...
              <StepLabel
                StepIconComponent={() =>
                  activeStep > 0 ? (
                    ...
                    <MinecraftLoader variant='blocks' size='inline' />
                  ) : (
                    <Circle size={20} />
                  )
                }
        ...
        <DialogActions>
          <MinecraftButton minecraftStyle='stone' onClick={() => setTestConnectionOpen(false)}>
            关闭
          </MinecraftButton>
        </DialogActions>
      </Dialog>
