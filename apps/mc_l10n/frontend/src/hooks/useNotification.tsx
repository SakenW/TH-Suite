...
} from '../components/minecraft/MinecraftNotification'
...
export const NotificationProvider: React.FC<NotificationProviderProps> = ({ children }) => {
  ...
  const notify = useCallback(
    (options: Omit<NotificationOptions, 'id'>): string => {
  ...
  const achievement = useCallback(
    (title: string, message?: string, options?: Partial<NotificationOptions>): string => {
      return notify({
        title: `🏆 ${title}`,
        message,
        type: 'achievement',
