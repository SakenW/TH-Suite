...
import { Box, Paper, Button, Typography, Card, Chip, LinearProgress, IconButton, Avatar } from '@mui/material';
    ...
    <Box sx={{ 
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 3, mb: 4 }}>
        <Paper sx={{ 
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box>
              <Typography variant="h4" sx={{ fontWeight: 700, color: '#2E7D32' }}>125</Typography>
              <Typography variant="body2" sx={{ color: '#757575' }}>模组总数</Typography>
            </Box>
        ...
        <Paper sx={{ 
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box>
              <Typography variant="h4" sx={{ fontWeight: 700, color: '#F57C00' }}>72%</Typography>
              <Typography variant="body2" sx={{ color: '#757575' }}>总体进度</Typography>
            </Box>
        ...
        <Paper sx={{ 
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box>
              <Typography variant="h4" sx={{ fontWeight: 700, color: '#2E7D32' }}>90</Typography>
              <Typography variant="body2" sx={{ color: '#757575' }}>已完成</Typography>
            </Box>
        ...
        <Paper sx={{ 
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box>
              <Typography variant="h4" sx={{ fontWeight: 700, color: '#D32F2F' }}>35</Typography>
              <Typography variant="body2" sx={{ color: '#757575' }}>待处理</Typography>
            </Box>
        ...
        <ModernPanel>
          ...
          <ModernCard>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box sx={{ textAlign: 'right' }}>
                <Typography variant="h6" sx={{ fontWeight: 700, color: '#2E7D32' }}>85%</Typography>
              </Box>
            </Box>
          ...
          <ModernCard>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box sx={{ textAlign: 'right' }}>
                <Typography variant="h6" sx={{ fontWeight: 700, color: '#F57C00' }}>32%</Typography>
              </Box>
            </Box>
          ...
          <ModernCard>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box sx={{ textAlign: 'right' }}>
                <Typography variant="h6" sx={{ fontWeight: 700, color: '#2E7D32' }}>100%</Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                  <Typography variant="body2" sx={{ color: '#424242' }}>核心模组</Typography>
                  <Typography variant="body2" sx={{ fontWeight: 600, color: '#2E7D32' }}>95%</Typography>
                </Box>
                <GradientProgress variant="determinate" value={95} />
              </Box>
              <Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                  <Typography variant="body2" sx={{ color: '#424242' }}>科技模组</Typography>
                  <Typography variant="body2" sx={{ fontWeight: 600, color: '#F57C00' }}>68%</Typography>
                </Box>
                <GradientProgress variant="determinate" value={68} />
              </Box>
              <Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                  <Typography variant="body2" sx={{ color: '#424242' }}>魔法模组</Typography>
                  <Typography variant="body2" sx={{ fontWeight: 600, color: '#F57C00' }}>45%</Typography>
                </Box>
