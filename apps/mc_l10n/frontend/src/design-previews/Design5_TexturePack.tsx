...
const WoodButton = styled(Button)({
  ...
  '&::before': {
    ...
    position: 'absolute',
    inset: 0,
    background: 'url("data:image/svg+xml,%3Csvg width="100" height="100" xmlns="http://www.w3.org/2000/svg"%3E%3Cpath d="M0 0h100v100H0z" fill="%23000" opacity="0.05"/%3E%3Cpath d="M0 20h100v2H0zM0 40h100v1H0zM0 60h100v2H0zM0 80h100v1H0z" fill="%23000" opacity="0.1"/%3E%3C/svg%3E")',
...
export default function Design5_TexturePack() {
  return (
    <Box sx={{ 
      minHeight: '100vh', 
      background: 'linear-gradient(180deg, #81C784 0%, #66BB6A 20%, #4CAF50 40%, #8D6E63 60%, #6D4C41 80%, #5D4037 100%)',
      padding: 4,
      position: 'relative',
      '&::before': {
        content: '""',
        position: 'absolute',
        inset: 0,
        background: 'url("data:image/svg+xml,%3Csvg width="60" height="60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23000" fill-opacity="0.03"%3E%3Cpath d="M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")',
      }
    }}>
      {/* 顶部栏 */}
      <StonePanel sx={{ mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
            <Avatar sx={{ 
              ...
              boxShadow: 'inset 0 0 10px rgba(255, 255, 255, 0.3), 0 4px 8px rgba(51, 105, 30, 0.4)',
            }}>
        ...
        <StonePanel>
          ...
          <Box sx={{
            ...
            '&::before': {
              ...
              position: 'absolute',
              inset: 0,
              background: 'url("data:image/svg+xml,%3Csvg width="100" height="100" xmlns="http://www.w3.org/2000/svg"%3E%3Cpath d="M0 20h100v2H0zM0 40h100v1H0zM0 60h100v2H0zM0 80h100v1H0z" fill="%23000" opacity="0.1"/%3E%3C/svg%3E")',
              backgroundSize: '100px 100px',
            }
          }}>
            <Typography sx={{ 
