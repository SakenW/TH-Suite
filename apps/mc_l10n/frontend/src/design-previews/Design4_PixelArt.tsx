...
const PixelPanel = styled(Paper)({
  ...
  '&::before': {
    ...
    bottom: '-4px',
    background:
      'repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(139, 115, 85, 0.1) 10px, rgba(139, 115, 85, 0.1) 20px)',
    pointerEvents: 'none',
  },
})
  ...
  return (
    <Box
      sx={{
        minHeight: '100vh',
        background:
          'repeating-linear-gradient(0deg, #87CEEB 0px, #87CEEB 100px, #98D8E8 100px, #98D8E8 200px)',
        padding: 4,
        position: 'relative',
        '&::before': {
          content: '""',
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
            <Box
              sx={{
                ...
                height: 64,
                background:
                  'repeating-linear-gradient(45deg, #4ADE80 0, #4ADE80 8px, #22C55E 8px, #22C55E 16px)',
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: 3 }}>
        ...
        <PixelPanel>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            <PixelButton fullWidth size='large' startIcon={<PlayArrowIcon />} sx={{ height: 48 }}>
              START
            </PixelButton>
            <PixelButtonRed fullWidth startIcon={<GetAppIcon />}>
              EXPORT
            </PixelButtonRed>
          </Box>
        </PixelPanel>
