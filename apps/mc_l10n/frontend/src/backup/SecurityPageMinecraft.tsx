...
export default function SecurityPageMinecraft() {
  ...
  const handleRevokeApiKey = (keyId: string) => {
    setAPIKeys(keys => keys.map(k => (k.id === keyId ? { ...k, status: 'revoked' } : k)))
  }
  ...
  return (
    <Box sx={{ p: 3 }}>
        ...
        <Grid item xs={12} md={3}>
          <MinecraftCard variant='enchantment'>
            <CardContent>
              ...
              <Typography
                variant='h5'
                sx={{ fontFamily: '"Minecraft", monospace', color: minecraftColors.emerald }}
              >
                高
              </Typography>
                ...
                <TableBody>
                  {users.map(user => (
                    <TableRow key={user.id} hover>
                      ...
                      <TableCell>{user.lastLogin?.toLocaleString() || '从未'}</TableCell>
                      <TableCell>
                      ...
                      <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                        {permission.risk === 'high' && (
                          <Chip
                            label='Admin'
                            size='small'
                            sx={{ bgcolor: getRoleColor('admin'), color: '#FFF' }}
                          />
                        )}
                        {(permission.risk === 'high' || permission.risk === 'medium') && (
                          <Chip
                            label='Developer'
                            size='small'
                            sx={{ bgcolor: getRoleColor('developer'), color: '#FFF' }}
                          />
                        )}
                        {permission.category === 'translation' && (
                          <Chip
                            label='Translator'
                            size='small'
                            sx={{ bgcolor: getRoleColor('translator'), color: '#FFF' }}
                          />
                        )}
                        {permission.risk === 'low' && (
                          <Chip
                            label='Viewer'
                            size='small'
                            sx={{ bgcolor: getRoleColor('viewer'), color: '#FFF' }}
                          />
                        )}
                      </Box>
                    </CardContent>
        ...
        <TabPanel value={selectedTab} index={2}>
          <Box sx={{ p: 3 }}>
                  ...
                  <CardContent>
                    ...
                    <List>
                      <ListItem>
                        ...
                        <ListItemText primary='主密钥' secondary='最后更新: 2024-03-01' />
                        <ListItemSecondaryAction>
                          <MinecraftButton
                            size='small'
                            minecraftStyle='gold'
                      ...
                      <ListItem>
                        ...
                        <ListItemText primary='数据库密钥' secondary='AES-256 加密' />
                        <ListItemSecondaryAction>
                          <IconButton edge='end'>
                            <Settings size={16} />
                          </IconButton>
                      ...
                      <ListItem>
                        ...
                        <ListItemText primary='传输加密' secondary='TLS 1.3 已启用' />
                        <ListItemSecondaryAction>
            ...
            <Box sx={{ mt: 3 }}>
              ...
              >
                <strong>重要：</strong>{' '}
                密钥轮换将影响所有加密数据的访问。请确保在执行此操作前备份所有重要数据。
              </Alert>
            </Box>
          </Box>
        </TabPanel>
          ...
          <Box sx={{ p: 3 }}>
            <Box sx={{ mb: 3, display: 'flex', justifyContent: 'space-between' }}>
              ...
              <Box sx={{ display: 'flex', gap: 2 }}>
                ...
                />
                <MinecraftButton minecraftStyle='stone' startIcon={<Download size={16} />}>
                  导出日志
                </MinecraftButton>
              </Box>
            </Box>
                      ...
                      <TableCell>
                        <Chip
                          ...
                          sx={{
                            bgcolor:
                              log.result === 'success'
                                ? minecraftColors.emerald
                                : log.result === 'failure'
                                  ? minecraftColors.redstoneRed
                  ...
                  <CardContent>
                    ...
                    <List>
                      <ListItem>
                        ...
                        <TextField size='small' type='number' defaultValue='8' sx={{ width: 80 }} />
                      </ListItem>
                      <ListItem>
                ...
                <MinecraftCard variant='crafting'>
                  <CardContent>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} md={6}>
                        <FormControlLabel control={<Switch defaultChecked />} label='IP白名单' />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <FormControlLabel
                          control={<Switch defaultChecked />}
                      ...
                      <Grid item xs={12} md={6}>
                        <FormControlLabel control={<Switch />} label='开发者模式' />
                      </Grid>
                      <Grid item xs={12} md={6}>
                        <FormControlLabel
                          control={<Switch defaultChecked />}
                    ...
                    <Box sx={{ mt: 3, display: 'flex', gap: 2 }}>
                      ...
                      <MinecraftButton minecraftStyle='stone' startIcon={<RefreshCw size={16} />}>
                        重置默认
                      </MinecraftButton>
                    </Box>
                  </CardContent>
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={2} sx={{ mt: 1 }}>
            <Grid item xs={12}>
              <TextField fullWidth label='用户名' defaultValue={selectedUser?.username} />
            </Grid>
            <Grid item xs={12}>
              <TextField fullWidth label='邮箱' type='email' defaultValue={selectedUser?.email} />
            </Grid>
            <Grid item xs={12}>
              <FormControl fullWidth>
                <InputLabel>角色</InputLabel>
                <Select defaultValue={selectedUser?.role || 'viewer'} label='角色'>
            ...
            {!selectedUser && (
              <Grid item xs={12}>
                <TextField fullWidth label='初始密码' type='password' />
              </Grid>
            )}
            <Grid item xs={12}>
              <FormControlLabel
      ...
      >
        <DialogTitle sx={{ fontFamily: '"Minecraft", monospace' }}>创建新的API密钥</DialogTitle>
        <DialogContent>
          <Grid container spacing={2} sx={{ mt: 1 }}>
            <Grid item xs={12}>
              <TextField fullWidth label='密钥名称' placeholder='例如: CI/CD Pipeline' />
            </Grid>
            <Grid item xs={12}>
              <FormControl fullWidth>
            ...
            <Grid item xs={12}>
              ...
              <FormControlLabel control={<Checkbox defaultChecked />} label='读取权限' />
              <FormControlLabel control={<Checkbox />} label='写入权限' />
              <FormControlLabel control={<Checkbox />} label='删除权限' />
              <FormControlLabel control={<Checkbox defaultChecked />} label='导出权限' />
            </Grid>
          </Grid>
        </DialogContent>
        <DialogActions>
          <MinecraftButton minecraftStyle='stone' onClick={() => setApiKeyDialogOpen(false)}>
            取消
          </MinecraftButton>
          <MinecraftButton minecraftStyle='emerald' onClick={() => setApiKeyDialogOpen(false)}>
            创建
          </MinecraftButton>
        </DialogActions>
      </Dialog>
      ...
      >
        <DialogTitle sx={{ fontFamily: '"Minecraft", monospace' }}>修改密码</DialogTitle>
        <DialogContent>
          <Grid container spacing={2} sx={{ mt: 1 }}>
            <Grid item xs={12}>
              <TextField
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={
                  confirmPassword !== '' && confirmPassword !== newPassword ? '密码不匹配' : ''
                }
              />
            </Grid>
          </Grid>
