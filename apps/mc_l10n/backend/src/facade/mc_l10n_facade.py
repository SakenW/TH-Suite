...
from ..domain.value_objects import (
    LanguageCode, FilePath, ContentHash, 
...
from ..application.services import ScanService
from ..infrastructure.unit_of_work import UnitOfWork, UnitOfWorkFactory
from ..infrastructure.event_bus import get_event_bus
from ..infrastructure.cache.cache_decorator import cache, cache_5min, invalidate_cache
...
class MCL10nFacade:
        ...
        try:
            with self.uow_factory.create() as uow:
                ...
                for mod_info in scan_context.discovered_mods:
                    try:
                        # 创建或更新Mod实体
                        mod = self._create_or_update_mod(mod_info, uow)
                        mods_found += 1
    ...
    def batch_translate(
        ...
        for mod_id in mod_ids:
            try:
                ...
                # 应用术语表
                if glossary:
                    translations = self._apply_glossary(translations, glossary, language)
        ...
        try:
            with self.uow_factory.create() as uow:
                ...
                project = TranslationProject(
                    ...
                    name=name,
                    target_languages=set(target_languages or [l.value for l in self.default_languages])
                )
    ...
    def check_quality(
        ...
        try:
            with self.uow_factory.create() as uow:
                ...
                # 计算平均质量分数
                scores = [t.quality_score.value for t in translations if t.quality_score]
    ...
    def _prepare_translations(self, translations: Dict[str, str]) -> Dict[str, Tuple[str, str]]:
        """准备翻译数据"""
        # 这里应该获取原文，现在简化处理
