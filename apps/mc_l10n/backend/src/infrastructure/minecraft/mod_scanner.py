...
class MinecraftModScanner:
    ...
    def _extract_mod_info(self, zip_file: zipfile.ZipFile, loader_type: str) -> Dict[str, Any]:
        """提取模组信息"""
        try:
    ...
    def _extract_forge_mc_version(self, data: Dict) -> Optional[str]:
        """提取Forge的Minecraft版本"""
    ...
    def _extract_fabric_mc_version(self, data: Dict) -> Optional[str]:
    ...
    def _extract_quilt_mc_version(self, data: Dict) -> Optional[str]:
        """提取Quilt的Minecraft版本"""
        quilt_loader = data.get('quilt_loader', {})
    ...
    def _extract_translations(self, zip_file: zipfile.ZipFile) -> Dict[str, Dict[str, str]]:
        """提取翻译文件"""
        translations = {}
