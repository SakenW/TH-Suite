...
class ProjectStatusChangedEvent(DomainEvent):
    ...
    def __init__(self, project_id: str, old_status: str, new_status: str, 
                 changed_by: str, timestamp: datetime):
        super().__init__(
...
class SyncCompletedEvent(DomainEvent):
    ...
    def __init__(self, sync_id: str, items_synced: int, conflicts_resolved: int, 
                 errors: int, timestamp: datetime):
        super().__init__(
...
class TranslationApprovedEvent(DomainEvent):
    ...
    def __init__(self, translation_id: str, mod_id: str, language: str, 
                 key: str, approved_by: str, timestamp: datetime):
        super().__init__(
...
class TranslationRejectedEvent(DomainEvent):
    ...
    def __init__(self, translation_id: str, mod_id: str, language: str, 
                 key: str, rejected_by: str, timestamp: datetime, reason: Optional[str] = None):
        super().__init__(
