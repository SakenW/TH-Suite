...
from application.queries import (
    GetModByIdQuery, 
    GetModsByStatusQuery,
    SearchModsQuery
)
from application.commands import DeleteModCommand
from application.dto import ModDTO, PagedResultDTO, ErrorDTO
...
async def get_mod_dependencies(
    ...
    try:
        ...
        return {
            ...
            "optional_dependencies": [] if not include_optional else [
                {
                    "mod_id": "jei",
                    "version": "15.2.0",
                    "required": False
