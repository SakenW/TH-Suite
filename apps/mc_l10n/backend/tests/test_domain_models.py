...
from domain.models.mod import Mod, ModId, ModState, ModVersion
from domain.models.translation_project import ProjectStatus, TranslationProject
...
class TestTranslationProject:
    ...
    def test_project_lifecycle(self):
        """测试项目生命周期"""
        project = TranslationProject(
            project_id="proj_001", name="Test Project", target_languages={"zh_cn"}
        )
